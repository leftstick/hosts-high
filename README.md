...
![](https://img.shields.io/badge/hosts-3.1.0-blue.svg)
![][david-url]
...
- Mac 11.11+: [64bit](https://github.com/leftstick/hosts-high/releases/download/3.1.0/Hosts.Master-3.1.0-mac.zip)
